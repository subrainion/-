...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        AddUser->setGeometry(QRect(1060, 0, 231, 71));
        DeleteUser = new QPushButton(centralwidget);
        DeleteUser->setObjectName("DeleteUser");
        DeleteUser->setGeometry(QRect(1060, 70, 231, 71));
